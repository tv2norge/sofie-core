...
> {
	...
	protected setupObserver(): void {
		this._dbObserver = this._coreHandler.setupObserver(this._collectionName) as ObserverForCollection<TCollection>
	...
	protected setupSubscription(...args: any[]): void {
	...
	private shallowClone(data: T | undefined): T | undefined {
	...
	protected getCollectionOrFail(): CoreCollection<CorelibPubSubCollections[TCollection]> {
		const collection = this._core.getCollection<CorelibPubSubCollections[TCollection]>(this._collectionName)
