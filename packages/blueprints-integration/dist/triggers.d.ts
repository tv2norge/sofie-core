...
import { SomeActionIdentifier, ClientActions, PlayoutActions } from '@sofie-automation/shared-lib/dist/core/model/ShowStyle';
...
export type SomeAction = IAdlibPlayoutAction | IRundownPlaylistActivateAction | IRundownPlaylistDeactivateAction | ITakeAction | IHoldAction | IMoveNextAction | ICreateSnapshotForDebugAction | IDisableNextPieceAction | IRundownPlaylistReloadDataAction | IRundownPlaylistResetAction | IRundownPlaylistResyncAction | IShelfAction | IGoToOnAirLineAction | IRewindSegmentsAction | IShowEntireCurrentSegmentAction | IMiniShelfQueueAdLib;
