...
export { TSR };
export { TimelineObjHoldMode, TimelineObjectCoreExt, TimelineKeyframeCoreExt, } from '@sofie-automation/shared-lib/dist/core/model/Timeline';
...
export interface OnGenerateTimelineObj<TContent extends {
    deviceType: TSR.DeviceType;
}, TMetadata = unknown, TKeyframeMetadata = unknown> extends TimelineObjectCoreExt<TContent, TMetadata, TKeyframeMetadata> {
